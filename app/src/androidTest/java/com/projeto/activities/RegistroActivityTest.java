...
public class RegistroActivityTest {
    ...
    @Test
    public void registroActivityTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.register_editText_usuario),
                        childAtPosition(
                                ...
                                2),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("yuri"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.register_editText_email),
                        childAtPosition(
                                ...
                                6),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("yteste10@gmail.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.register_editText_senha), withText("123456"),
                        childAtPosition(
                                allOf(withId(R.id.cronstrain),
                                        childAtPosition(
                                                withClassName(is("androidx.core.widget.NestedScrollView")),
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.register_editText_senha_repita), withText("123456"),
                        childAtPosition(
                                allOf(withId(R.id.cronstrain),
                                        childAtPosition(
                                                withClassName(is("androidx.core.widget.NestedScrollView")),
